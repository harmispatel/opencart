<!--
    THIS IS HEADER UserEdit PAGE FOR ADMIN PANEL
    ----------------------------------------------------------------------------------------------
    edit.blade.php
    This for Edit User
    ----------------------------------------------------------------------------------------------
                                ...
                                <div class="card-body">
                                        ...
                                        <select name="usersgroup" id="usersgroup"
                                            ...
                                            @foreach ($usersgroup as $usergroup)
                                                <option value="{{ $usergroup->user_group_id }}"
                                                    {{ $users->user_group_id == $usergroup->user_group_id ? 'selected' : '' }}>
                                        ...
                                        <select name="store" id="store"
                                            ...
                                            @foreach ($stores as $store)
                                                <option value="{{ $store->store_id }}"
                                                    {{ $users->user_shop == $store->store_id ? 'selected' : '' }}>
                                                    {{ $store->name }}</option>
                                            @endforeach
                                        </select>
                                        @if ($errors->has('store'))
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="status" class="form-control">
                                            <option value="1" {{ $users->status == 1 ? 'selected' : '' }}>Enabled
                                            </option>
                                            <option value="0" {{ $users->status == 0 ? 'selected' : '' }}>Disabled
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="card-footer">
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary"><i class="fa fa-save">
                                                Update</i></button>
                                        <a href="{{ route('users') }}" class="btn btn-danger"><i
