                            ...
                            <div class="card-header" style="background: #f6f6f6">
                                ...
                                <div class="container" style="text-align: right">
                                    @if(check_user_role(71) == 1)
                                        <a href="{{ route('addmanufacturer') }}" class="btn btn-sm btn-success ml-auto"><i class="fa fa-plus"></i></a>
                                    @endif
                            ...
                            {{-- End Card Header --}}
                                ...
                                <div class="card-body">
                                    <table class="table">
                                        ...
                                        <tbody class="text-center manufacturer-list">
                                                @foreach ($manufacturers as $manufacturer )
                                                    <tr>
                                                        <td>
                                                            <input type="checkbox" name="del_all" class="del_all" value="{{ $manufacturer->manufacturer_id }}">
                                                        </td>
                                                        <td>{{ $manufacturer->name }}</td>
                                                        <td>{{ $manufacturer->sort_order }}</td>
                                                        <td>
                                                            @if(check_user_role(72) == 1)
                                                                <a href="{{ route('editmanufacturer',$manufacturer->manufacturer_id) }}" class="btn btn-sm btn-primary rounded"><i class="fa fa-edit"></i></a>
                                                            @else
                                                                -
                                                            @endif
                                                        </td>
