<!--
    THIS IS EDIT CUSTOMER PAGE FOR ADMIN PANEL
    ----------------------------------------------------------------------------------------------
    edit.blade.php
    It's used for edit Customer & Displayed Other Tabs Like
    -------------------------------------------------------
    - General
    - History
    - Transactions
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="customer_group_id" id="customergroup" class="form-control">
                                                                @foreach ($customergroups as $group)
                                                                    <option value="{{ $group->hasOneCustomerGroupDescription->customer_group_id }}" {{ ($group->hasOneCustomerGroupDescription->customer_group_id == $customer->customer_group_id) ? 'selected' : '' }}>{{ $group->hasOneCustomerGroupDescription->name }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
...
<script type="text/javascript">
    ...
    // Function of Get Region by Country
    ...
    // End Function of Get Region by Country
    ...
    // End Get Customer Reward Points
    ...
    // End Add Customer Reward Points
