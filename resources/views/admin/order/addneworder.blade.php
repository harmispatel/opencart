                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-customer" role="tabpanel"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="cgroup">
                                    @foreach ($Customers as $Customer)
                                        <option value="{{ $Customer->customer_group_id }}">{{ $Customer->name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="fax" id="fax" value="" type="text"
                                    placeholder="Fax">
                        ...
                        <div class="tab-pane fade" id="nav-payment" role="tabpanel" aria-labelledby="nav-payment-tab">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="pfirstname" id="pfname" value="" type="text"
                                    placeholder="First name">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="plastname" id="plname" value="" type="text"
                                    placeholder="Last name">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="pcompany" id="pcompany" value="" type="text"
                                    placeholder="Company">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="paddress1" id="address1" value="" type="text"
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="address2" value="" type="text"
                                    placeholder="Address 2">

                            </div>
                            <div class="form-group">
                                <label for="pcity">* City</label>
                                <input class="form-control" name="pcity" id="pcity" value="" type="text"
                                    placeholder="City">
                                @if ($errors->has('pcity'))
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="ppostcode" id="ppostcode" type="text"
                                    placeholder="Postcode">
                            </div>
                            <div class="form-group">
                                <label for="country_id">* Country</label>
                                <select class="form-control country_id" name="pcountry" id="country_id"
                                    onchange="statespayment();">
                        ...
                        <div class="tab-pane fade" id="nav-shipping" role="tabpanel"
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="sfirstname" id="sfname" value="" name="sfname"
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="slastname" id="slname" value="" type="text"
                                    placeholder="Last name">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="scompany" id="scompany" value="" type="text"
                                    placeholder="Company">

                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">* Address 1</label>
                                <input class="form-control" name="saddress1" id="saddress1" value="" type="text"
                                    placeholder="Address 1">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="saddress2" id="saddress2" value="" type="text"
                                    placeholder="Address 2">

                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">* City</label>
                                <input class="form-control" name="scity" id="scity" value="" type="text"
                                    placeholder="City">
                                @if ($errors->has('scity'))
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="spostcode" id="spostcode" value="" type="text"
                                    placeholder="Postcode">
                            </div>
                            <div class="form-group">
                                <label for="country_id1">* Country</label>
                                <select class="form-control country_id" name="country_id1" id="country_id1"
                                    onchange="statesshipping();">
                                    <option>Select Country</option>
                                    @foreach ($countries as $country)
                                        <option value="{{ $country->country_id }}">{{ $country->name }}</option>
                                    @endforeach
                        ...
                        <div class="tab-pane fade show" id="nav-vouchers" role="tabpanel"
                            ...
                            <fieldset>
                                ...
                                <form class="form-horizontal" id="orderhistoryform">
                                    {{ csrf_field() }}
                                    <div class="form-group">
                                        <label class="control-label" for="input-order-status">* Recipient's
                                            Name</label>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label" for="input-order-status">* Recipient's
                                            Email</label>
                                        <input class="form-control" name="remail" type="text"
                                            placeholder="Default input">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="senderemail" type="text"
                                            placeholder="Default input">
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label" for="input-comment">* Gift Certificate
                                            Theme</label>
                                        <select class="form-control" name="giftcertheme">
                                            @foreach ($voucherdesc as $voucher)
                                                <option value="{{ $voucher->voucher_theme_id }}">
                                                    {{ $voucher->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="amount" type="text" value="25.00"
                                            placeholder="Default input">
                                    </div>
                                    <div class="text-right">
                                        <button id="button-history" class="btn btn-primary">Add History</button>
                            ...
                            <fieldset>
                                ...
                                <form class="form-horizontal" id="orderhistoryform">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="paymentmethod" type="text"
                                            placeholder="Default input">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control">
                                            @foreach ($orderstatus as $status)
                                                <option value="{{ $status->order_status_id }}">{{ $status->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
