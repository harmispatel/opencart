                                            ...
                                            <div class="row mt-4">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <label>Region</label>
                                                        <select class="form-control {{ ($errors->has('config_zone_id')) ? 'is-invalid' : '' }}" id="config_zone_id" name="config_zone_id"></select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control {{ ($errors->has('map_post_code')) ? 'is-invalid' : '' }}" id="map_post_code" name="map_post_code" value="{{ $map_category['map_post_code'] }}">
