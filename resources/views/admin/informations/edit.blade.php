                                    ...
                                    <div class="tab-content pt-4" id="myTabContent">
                                        ...
                                        <div class="tab-pane fade show active" id="genral" role="tabpanel" aria-labelledby="genral-tab">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control {{ ($errors->has('description')) ? 'is-invalid' : '' }}" name="description" id="summernote">{{ strip_tags($information->description) }}</textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="metatitle" class="form-control {{ ($errors->has('metatitle')) ? 'is-invalid' : '' }}" id="metatitle" value="{{ $information->meta_title }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="metadescription" id="metadescription">{{  $information->meta_description }}</textarea>
                                            </div>

                                            <div class="form-group">
                                                <label for="metakeyword" class="form-label">Meta Tag Keywords</label>
                                                <textarea class="form-control" name="metakeyword" id="metakeyword">{{ $information->meta_keyword }}</textarea>
                                            </div>
                                        ...
                                        <div class="tab-pane fade" id="data" role="tabpanel" aria-labelledby="data-tab">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-control" style="background: #e3e3e3">
                                                    <input type="checkbox" name="default" id="default" value="1" {{ (isset($store)) ? 'checked' : '' }}>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-control" style="background: #e3e3e3">
                                                    <input type="checkbox" name="bottom" id="bottom" value="1" {{ ($information->bottom == 1) ? 'checked' : '' }}>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="status" id="status" class="form-control">
                                                    <option value="1" {{ ($information->status == 1) ? 'selected' : '' }}>Enabled</option>
                                                    <option value="0" {{ ($information->status == 0) ? 'selected' : '' }}>Disabled</option>
                                                </select>
                                            </div>

                                            <div class="form-group">
                                                <label for="sortorder">Sort Order</label>
                                                <input type="number" name="sortorder" id="sortorder" class="form-control" value="{{ $information->sort_order }}">
                                            </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input type="text" name="keyword" placeholder="Keyword" class="form-control" aria-describedby="basic-addon1" aria-label="Keyword" value="{{ $seo->keyword }}">
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                                        ...
                                                        <td>
                                                            <select name="designid" class="form-control" id="designid">
                                                                ...
                                                                @foreach ($layouts as $layout)
                                                                    <option value="{{ $layout->layout_id }}" {{ ($information->layout_id == $layout->layout_id) ? 'selected' : '' }}>{{ $layout->name }}</option>
                                                                @endforeach
                                                            </select>
                                                        </td>
                                                    </tr>
