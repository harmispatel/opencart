                            ...
                            <div class="card-header" style="background: #f6f6f6">
                                ...
                                <div class="container" style="text-align: right">
                                    @if(check_user_role(79) == 1)
                                        <a href="{{ route('addfilter') }}" class="btn btn-sm btn-success ml-auto"><i class="fa fa-plus"></i></a>
                                    @endif
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody class="text-center review-list">
                                        @foreach ($filtergroups as $filtergroup )
                                            <tr>
                                                <td>
                                                    <input type="checkbox" name="del_all" class="del_all" value="{{ $filtergroup->filter_group_id }}">
                                                </td>
