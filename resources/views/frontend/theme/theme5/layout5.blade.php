<link href="https://fonts.googleapis.com/css2?family=Lato:wght@400;700&amp;family=Playfair+Display:wght@400;700&amp;display=swap" rel="stylesheet"/>
    ...
    <sidebar class="mobile-menu"><a class="close far fa-times-circle" href="#"></a><a class="logo" href="#slide"><img class="img-fluid" src="{{ asset('public/assets/theme5/img/logo/black-logo.svg') }}"/></a>
      <div class="top">
        <ul class="menu">
          ...
          <div class="col-md-6 col-sm-12 col-lg-7 wow animate__fadeInRight position-relative" data-wow-duration="1s">
            <div class="home-slide-v5-swiper swiper">
              <div class="swiper-wrapper">
                <div class="swiper-slide"><img class="img-fluid" src="{{ asset('public/assets/theme5/demo-data/slider.png') }}"/></div>
                <div class="swiper-slide"><img class="img-fluid" src="{{ asset('public/assets/theme5/demo-data/slider.png') }}"/></div>
                <div class="swiper-slide"><img class="img-fluid" src="{{ asset('public/assets/theme5/demo-data/slider.png') }}"/></div>
              </div>
              <div class="happy-customers"><strong class="text-uppercase">our happy customers</strong>
                <div class="__img-list">
                  <div class="__img"><img class="img-fluid" src="{{ asset('public/assets/theme5/demo-data/girl.jpeg') }}"/></div>
                  <div class="__img"><img class="img-fluid" src="{{ asset('public/assets/theme5/demo-data/girl.jpeg') }}"/></div>
                  <div class="__img"><img class="img-fluid" src="{{ asset('public/assets/theme5/demo-data/girl.jpeg') }}"/></div>
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="swiper-slide-item">
                <div class="img"><img class="img-fluid" src="{{ asset('public/assets/theme5/demo-data/best-categories/0.jpg') }}"/></div>
                <div class="__text-content">
                  <h4 class="text-uppercase">waldorf salad with</h4><strong class="text-uppercase">category name</strong>
                </div>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="swiper-slide-item">
                <div class="img"><img class="img-fluid" src="{{ asset('public/assets/theme5/demo-data/best-categories/1.jpg') }}"/></div>
                <div class="__text-content">
                  <h4 class="text-uppercase">waldorf salad with</h4><strong class="text-uppercase">category name</strong>
                </div>
              </div>
            ...
            <div class="swiper-slide">
              <div class="swiper-slide-item">
                <div class="img"><img class="img-fluid" src="{{ asset('public/assets/theme5/demo-data/best-categories/2.jpg') }}"/></div>
                <div class="__text-content">
                  <h4 class="text-uppercase">waldorf salad with</h4><strong class="text-uppercase">category name</strong>
                </div>
              </div>
    ...
    <section class="who-are-we-v5 pt-75 pb-75 wow animate__fadeInUp" data-wow-duration="1s">
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-6"><img class="img-fluid" src="{{ asset('public/assets/theme5/img/bg/about-us.png') }}"/></div>
        ...
        <div class="row">
          ...
          <div class="col-md-12 col-lg-8">
            <div class="swiper">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <div class="item"><a class="fas fa-search-plus" href="{{ asset('public/assets/theme5/demo-data/photo-gallery/0.jpg') }}" data-fancybox="photoGallery"></a><img class="img-fluid" src="{{ asset('public/assets/theme5/demo-data/photo-gallery/0.jpg') }}"/></div>
                </div>
                <div class="swiper-slide">
                  <div class="item"><a class="fas fa-search-plus" href="{{ asset('public/assets/theme5/demo-data/photo-gallery/1.jpg') }}" data-fancybox="photoGallery"></a><img class="img-fluid" src="{{ asset('public/assets/theme5/demo-data/photo-gallery/1.jpg') }}"/></div>
                </div>
                <div class="swiper-slide">
                  <div class="item"><a class="fas fa-search-plus" href="{{ asset('public/assets/theme5/demo-data/photo-gallery/2.jpg') }}" data-fancybox="photoGallery"></a><img class="img-fluid" src="{{ asset('public/assets/theme5/demo-data/photo-gallery/2.jpg') }}"/></div>
                </div>
                <div class="swiper-slide">
                  <div class="item"><a class="fas fa-search-plus" href="{{ asset('public/assets/theme5/demo-data/photo-gallery/3.jpg') }}" data-fancybox="photoGallery"></a><img class="img-fluid" src="{{ asset('public/assets/theme5/demo-data/photo-gallery/3.jpg') }}"/></div>
                </div>
                <div class="swiper-slide">
                  <div class="item"><a class="fas fa-search-plus" href="{{ asset('public/assets/theme5/demo-data/photo-gallery/0.jpg') }}" data-fancybox="photoGallery"></a><img class="img-fluid" src="{{ asset('public/assets/theme5/demo-data/photo-gallery/0.jpg') }}"/></div>
                </div>
    ...
    <section class="opening-hours-v5 pt-75 wow animate__fadeInUp" data-wow-duration="1s">
      ...
      <div class="__info">
        <div class="__container"><img class="img-fluid mb-3" src="{{ asset('public/assets/theme5/img/icon/time-top-flower.svg') }}"/><strong class="__time-title">OPEN NOW</strong>
