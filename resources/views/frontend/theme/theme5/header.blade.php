<header class="header-v5">
    <div class="header-top wow animate__fadeInDown" data-wow-duration="1s">
      <div class="container">
        <div class="working-time"><strong class="text-uppercase">Working Time:</strong><span>09:00 - 23:00</span></div><a class="logo" href="#slide"><img class="img-fluid" src="{{ asset('public/assets/theme5/img/logo/logo.svg') }}"/></a>
    ...
    <div class="header-bottom wow animate__fadeInDown" data-wow-duration="1s">
      <div class="container">
        ...
        <div class="restaurant-status open wow animate__bounceInDown" data-wow-duration="1s"><img class="img-fluid" src="{{ asset('public/assets/theme5/img/icon/open.svg') }}"/><img class="img-fluid" src="{{ asset('public/assets/theme5/img/icon/closed.svg') }}"/></div>
        <ul class="menu">
