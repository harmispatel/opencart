<link href="https://fonts.googleapis.com/css2?family=Bitter:wght@400;700&amp;family=Oswald:wght@400;500&amp;family=Raleway:wght@400;700&amp;display=swap" rel="stylesheet"/>
    ...
    <div class="home-slide-v2 swiper wow animate__fadeInDown" data-wow-duration="1s">
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide" style="background-image: url({{ asset('public/assets/theme2/demo-data/home-slide.jpg') }})">
          <div class="container">
            <h3 class="text-capitalize">star kebab & pizza 1</h3><img class="img-fluid __icon" src="{{ asset('public/assets/theme2/img/icon/slide-divider.svg') }}"/>
            <p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in  nulla pariatur anim id est laborum sunt in dolor in reprehenderit in.</p><a class="text-uppercase" href="#">read more<span></span></a>
          </div>
        </div>
        <div class="swiper-slide" style="background-image: url({{ asset('public/assets/theme2/demo-data/home-slide.jpg')}})">
          <div class="container">
            <h3 class="text-capitalize">star kebab & pizza 2</h3><img class="img-fluid __icon" src="{{ asset('public/assets/theme2/img/icon/slide-divider.svg') }}"/>
            <p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in  nulla pariatur anim id est laborum sunt in dolor in reprehenderit in.</p><a class="text-uppercase" href="#">read more<span></span></a>
          </div>
        </div>
      </div>
    ...
    <div class="about-us container wow animate__fadeInUp" data-wow-duration="1s">
      <div class="row">
        <div class="col-md-12 col-lg-6 img"><img class="img-fluid" src="{{ asset('public/assets/theme2/demo-data/about-us.jpg') }}"/></div>
        <div class="col-md-12 col-lg-6 content"><strong class="sub-title text-capitalize">star kebab & pizza</strong>
          ...
          <div class="about-us-swiper swiper">
            <div class="swiper-wrapper">
              <div class="swiper-slide"><img class="img-fluid" src="{{ asset('public/assets/theme2/demo-data/about-us-slider/1.jpg') }}"/></div>
              <div class="swiper-slide"><img class="img-fluid" src="{{ asset('public/assets/theme2/demo-data/about-us-slider/2.jpg') }}"/></div>
              <div class="swiper-slide"><img class="img-fluid" src="{{ asset('public/assets/theme2/demo-data/about-us-slider/3.jpg') }}"/></div>
              <div class="swiper-slide"><img class="img-fluid" src="{{ asset('public/assets/theme2/demo-data/about-us-slider/1.jpg') }}"/></div>
              <div class="swiper-slide"><img class="img-fluid" src="{{ asset('public/assets/theme2/demo-data/about-us-slider/2.jpg') }}"/></div>
              <div class="swiper-slide"><img class="img-fluid" src="{{ asset('public/assets/theme2/demo-data/about-us-slider/3.jpg') }}"/></div>
              <div class="swiper-slide"><img class="img-fluid" src="{{ asset('public/assets/theme2/demo-data/about-us-slider/1.jpg') }}"/></div>
