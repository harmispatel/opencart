<header class="header-v2">
    <div class="header-top wow animate__fadeInDown" data-wow-duration="1s">
      <div class="container">
        ...
        <div class="restaurant-status open wow animate__bounceInDown" data-wow-duration="1s"><img class="img-fluid" src="{{ asset('public/assets/theme2/img/icon/open.svg') }}"/><img class="img-fluid" src="{{ asset('public/assets/theme2/img/icon/closed.svg') }}"/></div><a class="logo" href="#slide"><img class="img-fluid" src="{{ asset('public/assets/theme2/img/logo/logo.svg') }}"/></a>
