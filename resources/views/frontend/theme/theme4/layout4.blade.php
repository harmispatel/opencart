<link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@400;700&amp;family=Playfair+Display:wght@400;700&amp;display=swap" rel="stylesheet"/>
    ...
    <sidebar class="mobile-menu"><a class="close far fa-times-circle" href="#"></a><a class="logo" href="#slide"><img class="img-fluid" src="{{ asset('public/assets/theme4/img/logo/black-logo.svg') }}"/></a>
      <div class="top">
        <ul class="menu">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 col-lg-7 position-relative">
            <div class="__circle">
              <div class="__thumbs-item"><a href="#" style="background-image: url({{ asset('public/assets/theme4/demo-data/home-slide/0.jpg') }})" data-index="0"></a><a href="#" style="background-image: url({{ asset('public/assets/theme4/demo-data/home-slide/1.jpg') }})" data-index="1"></a><a href="#" style="background-image: url({{ asset('public/assets/theme4/demo-data/home-slide/2.jpg') }})" data-index="2"></a></div>
            </div>
            <div class="__circle"></div>
            <div class="__circle"></div>
            <div class="swiper">
              <div class="swiper-wrapper">
                <div class="swiper-slide"><img class="img-fluid" src="{{ asset('public/assets/theme4/demo-data/slider.jpg')}}"/></div>
                <div class="swiper-slide"><img class="img-fluid" src="{{ asset('public/assets/theme4/demo-data/slider.jpg')}}"/></div>
                <div class="swiper-slide"><img class="img-fluid" src="{{ asset('public/assets/theme4/demo-data/slider.jpg')}}"/></div>
              </div>
            </div>
    ...
    <section class="who-are-we-v4 pt-75 pb-75 wow animate__fadeInUp" data-wow-duration="1s">
      <div class="container">
        <div class="row">
          ...
          <div class="col-12 col-md-12 col-lg-6 img"><img class="img-fluid" src="{{ asset('public/assets/theme4/img/bg/who-are-we.png')}}"/></div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row list-item">
          <div class="col-12 col-sm-6 col-lg-3">
            <div class="item">
              <div class="img"><img class="img-fluid" src="{{ asset('public/assets/theme4/demo-data/best-categories/0.jpg') }}"/></div>
          ...
          <div class="col-12 col-sm-6 col-lg-3">
            <div class="item">
              <div class="img"><img class="img-fluid" src="{{ asset('public/assets/theme4/demo-data/best-categories/1.jpg') }}"/></div>
          ...
          <div class="col-12 col-sm-6 col-lg-3">
            <div class="item">
              <div class="img"><img class="img-fluid" src="{{ asset('public/assets/theme4/demo-data/best-categories/3.jpg') }}"/></div>
      ...
      <div class="container">
        ...
        <div class="row list-item">
          <div class="col-12 col-md-6">
            <div class="item">
              <div class="img"><img class="img-fluid" src="{{ asset('public/assets/theme4/demo-data/popular-foods/1.jpg') }}"/></div>
    ...
    <section class="user-comments-v4 pt-75 pb-75">
      <div class="container pt-110 pb-110 wow animate__fadeInUp" data-wow-duration="1s">
        <div class="default-title-v4 text-center mb-0"><strong class="sub-title color-green">Reviews</strong>
          <h3 class="title">Recent Web Reviews</h3><img class="img-fluid" src="{{ asset('public/assets/theme4/img/icon/commit-icon.svg') }}"/>
        </div>
    ...
    <div class="photo-gallery-v4 pt-75 pb-75">
      ...
      <div class="list-item-container">
        <div class="list-item">
          <div class="item"><a class="fas fa-search-plus" href="{{ asset('public/assets/theme4/demo-data/photo-gallery/0.jpg') }}" data-fancybox="photoGallery"></a><img class="img-fluid" src="{{ asset('public/assets/theme4/demo-data/photo-gallery/0.jpg') }}"/></div>
          <div class="item"><a class="fas fa-search-plus" href="{{ asset('public/assets/theme4/demo-data/photo-gallery/1.jpg') }}" data-fancybox="photoGallery"></a><img class="img-fluid" src="{{ asset('public/assets/theme4/demo-data/photo-gallery/1.jpg') }}"/></div>
          <div class="item"><a class="fas fa-search-plus" href="{{ asset('public/assets/theme4/demo-data/photo-gallery/2.jpg') }}" data-fancybox="photoGallery"></a><img class="img-fluid" src="{{ asset('public/assets/theme4/demo-data/photo-gallery/2.jpg') }}"/></div>
          <div class="item"><a class="fas fa-search-plus" href="{{ asset('public/assets/theme4/demo-data/photo-gallery/3.jpg') }}" data-fancybox="photoGallery"></a><img class="img-fluid" src="{{ asset('public/assets/theme4/demo-data/photo-gallery/3.jpg') }}"/></div>
          <div class="item"><a class="fas fa-search-plus" href="{{ asset('public/assets/theme4/demo-data/photo-gallery/4.jpg') }}" data-fancybox="photoGallery"></a><img class="img-fluid" src="{{ asset('public/assets/theme4/demo-data/photo-gallery/4.jpg') }}"/></div>
          <div class="item"><a class="fas fa-search-plus" href="{{ asset('public/assets/theme4/demo-data/photo-gallery/5.jpg') }}" data-fancybox="photoGallery"></a><img class="img-fluid" src="{{ asset('public/assets/theme4/demo-data/photo-gallery/5.jpg') }}"/></div>
          <div class="item"><a class="fas fa-search-plus" href="{{ asset('public/assets/theme4/demo-data/photo-gallery/6.jpg') }}" data-fancybox="photoGallery"></a><img class="img-fluid" src="{{ asset('public/assets/theme4/demo-data/photo-gallery/6.jpg') }}"/></div>
          <div class="item"><a class="fas fa-search-plus" href="{{ asset('public/assets/theme4/demo-data/photo-gallery/7.jpg') }}" data-fancybox="photoGallery"></a><img class="img-fluid" src="{{ asset('public/assets/theme4/demo-data/photo-gallery/7.jpg') }}"/></div>
        </div>
      </div>
