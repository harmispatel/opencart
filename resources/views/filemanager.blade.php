...
<body>
  ...
  <nav class="bg-light fixed-bottom border-top d-none" id="actions">
    ...
    <a data-action="use" onclick="closePopupAndSetPath();" data-imageId="0" id="test" data-multiple="true"><i class="fas fa-check"></i>{{ trans('laravel-filemanager::lfm.btn-confirm') }}</a>
  </nav>
  ...
  <script src="{{ asset('public/vendor/laravel-filemanager/js/common.js') }}"></script>
