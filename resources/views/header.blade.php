...
<head>
  ...
  {{-- <link rel="shortcut icon" sizes="114x114" href="{{{ asset('public/admin/favicon/myfoodbasket.png') }}}"> --}}
        ...
        @if ($user_group_id == 1)
            ...
            <li class="nav-item pl-3 pt-2 pr-3">
                ...
                @if ($current_store_id == 0)
                    <a href="https://the-public.co.uk/" target="_blanck" id="visitShop">Visit Shop</a>
                @else
